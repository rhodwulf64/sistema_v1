...
function DibCombMotivoAnulacionDes($cod){
	$obj_motivoAnu = new ClsMotivo();
	$rs = $obj_motivoAnu->motivoDeAnulacionDes();
	$combMotivo = array();
	$selec = "";
	$c = 0;
...
function DibCombMotivoAnulacionDev($cod){
...
function DibCombMotivoAnulacionDesAnul($cod){
	$obj_motivoAnu = new ClsMotivo();
	$rs = $obj_motivoAnu->motivoDeAnulacionDesAnul();
	$combMotivo = array();
	$selec = "";
	$c = 0;
