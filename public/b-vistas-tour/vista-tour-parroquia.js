...
$( ".element-parroquia" ).click(function() {
	var tour = new Tour({
		steps: [
		{
			element: ".parroquia-tour",
			title: "Bienvenidos",
		...
		},
		{
			...
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre del municipio.",
			placement:"left",
      		duration:"20000"
		},
			{
			element: ".municipio1-tour",
			title: "Bienvenidos",
			content: "En este campo seleccionamos el estado del municipio.",
			placement:"left",
      		duration:"20000"
		}
