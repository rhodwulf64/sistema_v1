$( ".element-tipobien" ).click(function() {
	var tour = new Tour({
		steps: [
		{
		...
		},
		{
			...
			element: ".codigo-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el codigo de la categoria.",
			placement:"left",
      		duration:"20000"
		},
			{
			element: ".nombretipobien-tour",
			title: "Bienvenidos",
			content: "En este campo Ingresamos el nombre del tipo del bien.",
			placement:"left",
      		duration:"20000"
		},	{
			element: ".nombrecategoria-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre de la categiria.",
			placement:"left",
      		duration:"20000"
		}
