...
$( ".element-motivo" ).click(function() {
	var tour = new Tour({
		...
		},
		{
			...
			{
			element: ".nombremotivo-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre del motivo .",
			placement:"left",
      		duration:"20000"
		},
				{
			element: ".tipomotivo-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el tipo de motivo .",
			placement:"left",
      		duration:"20000"
		}
