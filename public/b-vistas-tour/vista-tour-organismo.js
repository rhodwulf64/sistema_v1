$( ".element-org" ).click(function() {
	var tour = new Tour({
		...
		},
		{
			...
			{
			element: ".codigoorganismo-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el codigo del organismo a registrar.",
			placement:"left",
      		duration:"20000"
		},
			{
			element: ".nombreorganismo-tour",
			title: "Bienvenidos",
			content: "En este campo Ingresamos el nombre del organismo.",
			placement:"left",
      		duration:"20000"
		},	{
			element: ".codigounidad-tour",
			title: "Bienvenidos",
			...
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre de la unidad administradora.",
			placement:"left",
      		duration:"20000"
		}	
		],
