...
$( ".element-desincorporacion" ).click(function() {
	var tour = new Tour({
		steps: [
		{
			element: ".desincorporacion-tour",
			title: "Bienvenidos",
		...
		{
			element: ".periododesincorporacion-tour",
			title: "Bienvenidos",
		...
		},
		{
			...
			{
			element: ".numerodedesincorporacion-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el numero de desincorporacion .",
			placement:"left",
      		duration:"20000"
		},
		{
			element: ".responsabledesincorporacion-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el responsable de la desincorporacion .",
			placement:"left",
      		duration:"20000"
		},
		{
			element: ".fechadesincorporacion-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos la fecha de la desincorporacion.",
			placement:"left",
      		duration:"20000"
		},
		{
			element: ".motivos-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el motivo por el cual estamos desincorporando .",
			placement:"left",
      		duration:"20000"
		},
		{
			...
			title: "Bienvenidos",
			content: "En este campo ingresamos observaciones de la desincorporacion .",
			placement:"left",
      		duration:"20000"
		},
		{
			element: ".detalles-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos observaciones de la desincorporacion .",
			placement:"left",
      		duration:"20000"
...
$( ".element-desincorporacion2" ).click(function() {
	var tour = new Tour({
		steps: [
		{
			element: ".desincorporacion2-tour",
			title: "Bienvenidos",
			content: "Nombre del Formulario Seleccionado",
			placement:"left",
      		duration:"20000"
		...
		{
			element: ".clickdesincorporacion-tour",
			title: "Bienvenidos",
