$( ".element-dep" ).click(function() {
	var tour = new Tour({
		...
		},
		{
			...
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre del departamento.",
			placement:"left",
      		duration:"20000"
		},
			{
			...
			title: "Bienvenidos",
			content: "En este campo seleccionamos la Sede en el combo.",
			placement:"left",
      		duration:"20000"
		},	{
			element: ".departamentodeposito-tour",
			title: "Bienvenidos",
			content: "Si el departamento es almacen tildamos el cheked.",
			placement:"left",
      		duration:"20000"
		}
