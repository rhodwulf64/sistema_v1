...
$( ".element-asignarusuario" ).click(function() {
	var tour = new Tour({
		steps: [
		{
			element: ".ausuario-tour",
			title: "Bienvenidos",
			content: "En este campo vamos a asignar el usuario",
			placement:"left",
      		duration:"20000"
		},
		{
			element: ".atipousuario-tour",
			title: "Bienvenidos",
			content: "En este campo vamos asignar el tipo de usuario",
			placement:"left",
      		duration:"20000"
		},
