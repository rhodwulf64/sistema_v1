...
$( ".element-tipodeusuario" ).click(function() {
	var tour = new Tour({
		steps: [
		{
			element: ".tipousuario-tour",
			title: "Bienvenidos",
		...
		},
		{
			...
			{
			element: ".nombretipousuario-tour",
			title: "Bienvenidos",
			content: "En este campo ingresamos el nombre del tipo de usuario .",
			placement:"left",
      		duration:"20000"
		}
