...
class Zebra_Pagination
{
    ...
    private $_properties = array(
        ...
        'next'                      =>  'Sig. <span class="icon-arrow-right2"></span>',
        ...
        'previous'                  =>  '<span class="icon-arrow-left2"></span> Ant.',
    ...
    private function _show_next()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li><a onClick="' .
                ...
                ($this->_properties['page'] == $this->_properties['total_pages'] ? 'javascript:void(0)' : "paginacionAjax(".($this->_properties['page'] + 1).")") .
    ...
    private function _show_pages()
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                $output .= '<li><a onClick="paginacionAjax('.$i.')" ' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li><a onClick="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '" ' .
            ...
            $output .= '<li><a onClick="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '" ' .
    ...
    private function _show_previous()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li><a onClick="' .
                ...
                ($this->_properties['page'] == 1 ? 'javascript:void(0)' : "paginacionAjax(".($this->_properties['page'] - 1).")") .
