...
if (isset($_SESSION['nivel'])){
	...
	$_SESSION["operativa-vista"] = "periodoCrear"; // variable para saber en que vista esta y asi no destruir sus variables de trabajo
...
<caption class="crearperiodo">Crear Período <span title="Clic para ver ayuda guiada"class="icon-magic-wand element-crearperiodo ayuda-local-frm ayudaguiada-tour"></span><a style="color:#fff;" href="../pdf_link/Bienes nacionales/Periodo1.pdf" target="_black"> <span id="ic-ayuda-frm" class="icon-question ayudapdf-tour" title="Clic para ver ayuda"></span></a></caption>
	<input type="hidden" name="id_periodo" value="<?php if(isset($_SESSION['id_periodo'])) echo $_SESSION['id_periodo'];?>"/>
	<!--<tr>
		<td>	
	...
	<tr>
		...
		<td><span class="espacio-frm-unico-campo-derecho"></span></td>
		<td id="r-paddig" class="MensajeAyuda nombreperiodo-tour">								
			...
			<input type="text" title="Este es el nombre del período" readonly="readonly" placeholder="Dia-Mes-Año" size="25" id="nom_periodo" name="nom_periodo" value="<?php if(isset($_SESSION['nom_periodo'])) echo $_SESSION['nom_periodo'];?>">
	...
	<tr>
		<td><span class="espacio-frm-unico-campo-derecho"></span></td>
		<td><span class="espacio-frm-unico-campo-derecho"></span></td>
		<td id="r-paddig" class="MensajeAyuda fechainicio-tour">								
			...
			<input type="text" title="Esta es la fecha inicio del período" readonly="readonly" placeholder="Dia-Mes-Año" size="25" id="fecha_inicio" name="fecha_inicio" value="<?php if(isset($_SESSION['fecha_inicio'])) echo $_SESSION['fecha_inicio'];?>">
			<span id="nube" class="nube" style="">Solo se Permiten Numeros</span>
		</td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
	...
	<tr>
		<td><span class="espacio-frm-unico-campo-derecho"></span></td>
		<td><span class="espacio-frm-unico-campo-derecho"></span></td>
		<td id="r-paddig" class="MensajeAyuda fechafin-tour">										
			...
			<input type="text" name="fecha_fin" title="Esta es la fecha fin del período" placeholder="Dia-Mes-Año" readonly="readonly" size="10" value="<?php if(isset($_SESSION['fecha_fin'])) echo $_SESSION['fecha_fin'];?>" />
			<span id="nube" class="nube" style="">Solo se Permiten Numeros</span>
		</td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
	...
	<tr id="botonera"class="botonera-tour">
		<td align="center" colspan="5"><br>
			...
			<input type="hidden" name="opActDes" value="<?php if(isset($_SESSION["opActDesPeriodo"])) echo $_SESSION["opActDesPeriodo"]; ?>">
			...
			<!-- Incluyo la botonera -->
			<button type="button" class="botoneranuevo-tour" title="Clic para incluir un periodo" name="inc" value="Incluir" onclick="General_periodo(this.value)"><span id="iconos" class="icon-file-empty"></span><span>Nuevo</span></button>				
			...
			<button type="button" class="botoneraguardar-tour" title="Clic para guardar un periodo" value="Grabar"     name="grab"   onclick="General_periodo(this.value)" disabled="disabled"><span id="iconos" class="icon-clipboard"></span><span>Guardar</span></button>				
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">En este formulario podra crear los Periodos fiscales de la organizacion
			<u>ejemplo:</u><br> - Periodo: 2015<br>
			Es necesario la creacion de un periodo antes de realizar movimientos en el inventario.<br>
			El Boton ayuda le facilita la descripciòn de cada operacion para el formulario Periodo. </p>
		</td>
	</tr>
</table>
