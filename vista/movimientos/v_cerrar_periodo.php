...
if (isset($_SESSION['nivel'])){
	...
	$_SESSION["operativa-vista"] = "periodCerrar"; // variable para saber en que vista esta y asi no destruir sus variables de trabajo
...
<caption class="cerrarperiodo-tour">Cerrar Período <span title="Clic para ver ayuda guiada"class="icon-magic-wand element-cerrarperiodo ayuda-local-frm ayudaguiada-tour"></span> <span id="ic-ayuda-frm" class="icon-question ayudapdf-tour" title="Clic para ver ayuda"></span></caption>
	<input type="hidden" name="id_periodo" value="<?php if(isset($_SESSION['id_periodo_cerrar'])) echo $_SESSION['id_periodo_cerrar'];?>"/>
	<!--<tr>
		<td>	
	...
	<tr>
		...
		<td id="r-paddig" class="MensajeAyuda nombredelperiodo-tour">								
			...
			<input type="text" title="Este es el nombre del período" readonly="readonly" placeholder="Dia-Mes-Año" size="25" id="nom_periodo" name="nom_periodo" value="<?php if(isset($_SESSION['nom_periodo_cerrar'])) echo $_SESSION['nom_periodo_cerrar'];?>">
	...
	<tr>
		...
		<td id="r-paddig" class="MensajeAyuda fechainicioperiodo-tour">								
			...
			<input type="text" title="Esta es la fecha inicio del período" readonly="readonly" placeholder="Dia-Mes-Año" size="25" id="fecha_inicio" name="fecha_inicio" value="<?php if(isset($_SESSION['fecha_inicio_cerrar'])) echo $_SESSION['fecha_inicio_cerrar'];?>">
			<span id="nube" class="nube" style="">Solo se Permiten Numeros</span>
		</td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
	...
	<tr>
		...
		<td id="r-paddig" class="MensajeAyuda fechafinperiodo-tour">										
			...
			<input type="text" name="fecha_fin" title="Esta es la fecha fin del período" placeholder="Dia-Mes-Año" readonly="readonly" size="10" value="<?php if(isset($_SESSION['fecha_fin_cerrar'])) echo $_SESSION['fecha_fin_cerrar'];?>" />
			<span id="nube" class="nube" style="">Solo se Permiten Numeros</span>
		</td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
		<td><span class="espacio-frm-unico-campo-Izquierdo"></span></td>
	...
	<tr id="botonera">
		<td align="center" colspan="5"><br>
			...
			<!-- Incluyo la botonera -->
			<button type="button" class="botoneranuevo-tour" title="Clic para abrir un periodo" name="inc" value="cerrar" onclick="General_periodo(this.value)"><span id="iconos" class="icon-file-zip"></span><span>Cerrar</span></button>				
			...
			<button type="button" class="botoneraguardar-tour" title="Clic para guardar la configuración" value="Grabar_cerrar" name="grab"   onclick="General_periodo(this.value)" disabled="disabled"><span id="iconos" class="icon-clipboard"></span><span>Guardar</span></button>				
