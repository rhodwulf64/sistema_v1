...
<div class="ventanaModal container" id="ventanaModal">
	<div class="contenido">
	<span id="identificador-modal-superio-izquierdo">Consultar Parroquia</span>
		<form method="POST" action="../../control/configuracion/c_parroquia.php" id="envio_Modal" name="envio_Modal">
			<ul class="tabla">
			...
			<?php include_once("../../modelo/configuracion/m_parroquia.php"); 
				$obj_municipio = new Clsparroquia();
				$tupla = $obj_municipio->Consultar_P_M_E();
				$c=1;
				$contenido="";
			?>
