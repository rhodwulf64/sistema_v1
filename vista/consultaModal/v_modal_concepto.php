...
<div class="ventanaModal container" id="ventanaModal">
	<div class="contenido">
	<span id="identificador-modal-superio-izquierdo">Consultar Concepto</span>
		<form method="POST" action="../../control/configuracion/c_concepto.php" id="envio_Modal" name="envio_Modal">
			<ul class="tabla">
			...
			<?php include_once("../../modelo/configuracion/m_concepto.php"); 
				$obj_concep = new ClsConcepto();
				$tupla = $obj_concep->ConsultarTodo();
				$c = 1;
				$contenido = "";
			?>
			...
			<tbody id="datosAjax">
				<?php while($rs = $obj_concep->Arreglo($tupla)){
