...
<div class="ventanaModal container" id="ventanaModal">
	<div class="contenido">
	<span id="identificador-modal-superio-izquierdo">Consultar Marca</span>
		<form method="POST" action="../../control/configuracion/c_marca.php" id="envio_Modal" name="envio_Modal">
			<ul class="tabla">
			...
			<?php include_once("../../modelo/configuracion/m_marca.php"); 
				$obj_org = new clsMarca();
