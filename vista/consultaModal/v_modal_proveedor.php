...
<div class="ventanaModal container" id="ventanaModal" style="overflow:auto;">
	<div class="contenido">
	<span id="identificador-modal-superio-izquierdo">Consultar Proveedor</span>
		<form method="POST" action="../../control/configuracion/c_proveedor.php" id="envio_Modal" name="envio_Modal">
			<ul class="tabla">
			...
			<?php include_once("../../modelo/configuracion/m_proveedor.php"); 
				$obj_proveedor = new clsProveedor();
				$tupla = $obj_proveedor->consultar();
				$c = 1;
				$contenido = "";
			?>
			...
			<tbody id="datosAjax">
				<?php while($rs = $obj_proveedor->converArray($tupla)){
