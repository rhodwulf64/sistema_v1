...
<div class="ventanaModal container" id="ventanaModal1">
	<div class="contenido">
	<span id="identificador-modal-superio-izquierdo">Desincorporación del Bien Nacional</span>
		<style type="text/css">
		.tipo-bien-asig{
			position: relative;
			font-weight: 600;
		...
		<form method="POST" action="../../control/movimientos/c_desincorporacion.php" id="envio_Modal" name="envio_Modal">
			<ul class="tabla">
