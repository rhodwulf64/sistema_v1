...
<table id="btn-home-table">
    <form method="POST" action="../../control/c_reportes/c_asignacion/c_asig_bn.php" target="_blank" name="envio_form">
<tr>
...
<td><label class="Reportes">Tipo de Bien:</label> 
	<?php
		...
		$cbotbien = array();
		$cod_tbien = "";
		if(isset($_SESSION['id_tbien_asig2']))
			$cod_tbien = $_SESSION['id_tbien_asig2'];
		else
			$cod_tbien = "";
