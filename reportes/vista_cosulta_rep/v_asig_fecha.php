...
<table id="btn-home-table">
    <form method="POST" action="../../control/c_reportes/c_asignacion/c_asig_fecha.php" target="_blank" name="envio_form">
<tr>
   <input type="button" name="btnSalir" id="btnSalir" value="Volver" onclick="location.href='?accion=r_asignacion';"> 
<td colspan="3"><h2>Reporte: Asignaciones por Fecha</h2></td>    
</tr>
<tr>
