...
<table id="btn-home-table">
    <form method="POST" action="../../control/c_reportes/c_devolucion/c_dev_bn.php" target="_blank" name="envio_form">
<tr>
        <input type="button" name="btnSalir" id="btnSalir" value="Volver" onclick="location.href='?accion=r_devolucion';">

<td colspan="3"><h2>Reporte: Listado de Devolución por Tipo de Bien Nacional</h2></td>    
</tr>
<tr>
...
<?php
		...
		$cbotbien = array();
		$cod_tbien = "";
		if(isset($_SESSION['id_tbien_dev2']))
			$cod_tbien = $_SESSION['id_tbien_dev2'];
		else
			$cod_tbien = "";
