...
<form method="POST" action="../../control/c_reportes/c_bienesNacionales/c_bitacora_mov.php" name="form_general">
<table id="btn-home-table">
	...
	<tr>
		<td>
		<h2>Filtrar Reporte de Bitacora de Movimientos</h2><br>
		<!--<span id="tReport">Tipo de Reporte: <input type="radio" name="tr" checked="checked" /> PDF </span>-->
