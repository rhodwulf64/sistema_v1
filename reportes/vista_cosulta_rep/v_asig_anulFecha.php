...
<table id="btn-home-table">
    <form method="POST" action="../../control/c_reportes/c_asignacion/c_asig_anulFecha.php" target="_blank" name="envio_form">
<tr>
    
<td colspan="3"><h2>Reporte: Listado de Asignaciones Anuladas por Fecha</h2></td>    
</tr>
<tr>
