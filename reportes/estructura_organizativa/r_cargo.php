...
<form method="POST" action="../../control/c_reportes/c_cargo.php" name="form_general">
<table id="btn-home-table">

	<tr>
		<td>
		<h2>Reporte de Cargos</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Cargos, la busqueda puede ser por aproximidad. Ejemplo: p, pa, pae ... paez. </p>
		</td>
	</tr>
</table>