...
<form method="POST" action="../../control/c_reportes/c_depart.php" name="form_general">
<table id="btn-home-table">

	<tr>
		<td>
		<h2>Filtrar Reporte de Departamento</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Departamento, la busqueda puede ser por aproximidad. Ejemplo: p, pa, pae ... paez. </p>
		</td>
	</tr>
</table>