...
<form method="POST" action="../../control/c_reportes/c_motivo.php" name="form_general">
<table id="btn-home-table">
	
	<tr>
		<td>
		<h2>Filtrar Reporte de Motivo</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Motivo, la busqueda puede ser por aproximidad. Ejemplo: d, do,  ... donación. </p>
		</td>
	</tr>
</table>