...
<form method="POST" action="../../control/c_reportes/c_prov.php" name="form_general">
<table id="btn-home-table">
	
	
	<tr>
		<td>
		<h2>Filtrar Reporte de Proveedor</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Proveedor, la busqueda puede ser por aproximidad. Ejemplo: c,co ... coposa. </p>
		</td>
	</tr>
</table>