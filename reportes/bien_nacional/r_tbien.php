...
<form method="POST" action="../../control/c_reportes/c_Tbien.php" name="form_general">
<table id="btn-home-table">
		
	<tr>
		<td>
		<h2>Filtrar Reporte de Tipo de Bien</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Tipo de Bien, la busqueda puede ser por aproximidad. Ejemplo: 2010 ... air. </p>
		</td>
	</tr>
</table>