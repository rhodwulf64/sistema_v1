...
<form method="POST" action="../../control/c_reportes/c_marca.php" name="form_general">
<table id="btn-home-table">
	
	
	<tr>
		<td>
		<h2>Filtrar Reporte de Marca</h2><br>
...
<table>
	<tr>
		<td>
			<p id="mesaje-descrip-maestra">Nota: en la caja de texto ingrese el nombre del Marca, la busqueda puede ser por aproximidad. Ejemplo: s, san, ... sansumg. </p>
		</td>
	</tr>
</table>