...
class PDF extends FPDF{
	...
	function Header(){
		...
		$this->Image('../../public/img/cic.png',250,4,28);
		...
		$this->Text(109,15,'REPUBLICA BOLIVARIANA DE VENEZUELA','C',0);
		$this->Text(75,20,$tupla1['nom_org'],'C',0);
		$this->Text(78,25,$tupla1['nom_ud'],'C',0);
		$this->Text(108,30,$tupla1['nom_sed'].'-'.$tupla1['nom_est'],'C',0);
		$this->Ln(18);
		$this->SetFont('Arial','B',14);
		$this->Cell(0,10,'Listado de Usuarios',0,0,'C');
		...
		$this->Cell(148,3,'Derechos Reservados por el '.$_SESSION['abrev_rep'].' '.$_SESSION['nom_sed_rep'],0,'');

		$this->Cell(114,-13,'Pagina'.$this->PageNo().'/{nb}','',0,'R');
		$this->Image('../../public/img/code_car.jpg',248,195,25);
