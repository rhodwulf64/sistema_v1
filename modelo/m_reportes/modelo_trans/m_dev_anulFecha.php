	...
	function buscar($POST){
		...
		$content='
			...
			*{
			...
			<pre style="margin-left:390px;">Fecha de Impresión: '.$fecha.'</pre>
			
			<h4 align="center">Devoluciones Anuladas por Fecha</h4>
			<p style="color:red;font-weight:bold;">DEVOLUCIÓN ANULADA </p>
            </div>
			</div>
