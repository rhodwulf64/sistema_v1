...
class ClsRecepcionAnul extends conex{
	private $datos,$valor; //variable para traer name por POST

	function ClsRecepcionAnul(){
		$this->conex();
		$this->datos="";
		$this->valor="";
	}
	...
	function buscar($POST){
		...
		if(isset($this->datos['nroAnul']) && $this->datos['nroAnul']==""){
		...
		$html='
			...
			*{
			...
			<p style="color:red;font-weight:bold;">RECEPCIÓN ANULADA</p>
            </div>
			</div>
