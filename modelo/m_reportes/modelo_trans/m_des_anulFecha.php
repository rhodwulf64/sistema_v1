	...
	function buscar($POST){
		...
		$content='
			...
			*{
			...
			<h4 align="center">Desincorporación Anulada por Fecha</h4>
			<p style="color:red;font-weight:bold;">DESINCORPORACIÓN ANULADA </p>
            </div>
			</div>
        ...
        // 	echo "<script>alert('NO HAY ANULACIONES POR ESTA FECHA');</script>";
        // 	return false;
        // }
		$footer="<page_footer>
		<style>
...
//******************FUNCION PARA BUSCAR ASIGNACIONES POR DEPARTAMENTO*********************************************//
