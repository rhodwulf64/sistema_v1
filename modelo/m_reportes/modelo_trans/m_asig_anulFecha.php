	...
	function buscar($POST){
		...
		$content='
			...
			*{
			...
			<h4 align="center">Asignaciones Anuladas por Fecha</h4>
			<p style="color:red;font-weight:bold;">ASIGNACION ANULADA </p>
            </div>
			</div>
