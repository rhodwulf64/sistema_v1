	...
	function buscar($POST){
		...
		$content='
			...
			*{
			...
			<h4 align="center">Devolucion Bienes Nacionales por Fecha</h4>
			<p style="color:red;font-weight:bold;">DEVOLUCION DE BIENES NACIONALES</p>
            </div>
			</div>
