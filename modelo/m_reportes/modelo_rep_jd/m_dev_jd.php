...
class ClsDevolucionJd extends conex{
	private $datos;
	function ClsDevolucionJd(){
		$this->conex();
		$this->datos="";
	}

	function buscar($cod,$resp){
 ...
 //echo $sql;
		...
		$html='
			...
			*{
			...
			<h4 align="center">Listado de Bienes Nacionales Devueltos</h4>
            </div>
			</div>
			<!--inicio de tabla del Listado -->
			<p id="negrita">Responsable del Dpto:'.$tupla1['conc'].'</p>
			<p>Motivo de Devolución: '.$tupla1['des_motivo_mov'].'</p>
			<p style="margin-top:-16px;" align="right">Fecha de Devolución: '.$fecha_mov.'</p>
			<br><br>
