...
class ClsAsignacionDep extends conex{
	private $datos;
	function ClsAsignacionDep(){
		$this->conex();
		$this->datos="";
	}
...
//echo $sql;
		...
		$html='
			...
			*{
			...
			<h4 align="center">Listado de Bienes Nacionales Asignados al Departamento</h4>
            </div>
			</div>
