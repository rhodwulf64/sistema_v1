...
class ClsAsignacionDepFecha extends conex{
	private $datos;
	function ClsAsignacionDepFecha(){
		$this->conex();
		$this->datos="";
	}

	function buscar($fecha2,$fecha1,$cod,$resp){
...
//echo $sql;
		...
		$html='
			...
			*{
			...
			<h4 align="center">Listado de Bienes Nacionales Asignados al Departamento por Fecha</h4><br>
            </div>
			</div>
			<!--inicio de tabla del Listado -->
			<p id="negrita">Responsable del Dpto:'.$tupla1['conc'].'</p>
			<p style="margin-top:-14px;" align="right">Fecha de Asignación: '.$fecha_mov.'</p>
			<br>
